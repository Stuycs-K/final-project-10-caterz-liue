...
public class BlobTable extends PoolTable{
  ...
  public void makeObstacles(){
    obstacles = new Obstacle[] {
      ...
      new Ice(1.05, new Blob(new PVector(-135,115), new PVector[] {new PVector(-100,100), new PVector(-150,100), new PVector(-150,150)}, new PVector[] {new PVector(-125, 80), new PVector(-170,120), new PVector(-80, 120)})),
    };
  }
